...
- [ ] 2.1 Attach/remove asset ids persists in order and cleans the orphan
- [ ] 2.2 Prevent-delete refuses a media row an investment points at
- [ ] 2.3 `pnpm exec vitest run src/__tests__/lib/actions/` passes
