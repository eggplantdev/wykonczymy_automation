...
// The column families that exist per plane, in assembly order — the mnożnik sits between its source
// and the stawka it produces, which is also the order they are read in.
